...
for j=1:nloop
    ...
    b1_n=[abs(umaster(nz1,n1)); abs(umaster(nz1,n2)); abs(umaster(nz1,n3)); abs(umaster(nz1,n4)); abs(umaster(nz1,n5))]+noise*randn(5,1);
    b2_n=[abs(umaster(nz2,n1)); abs(umaster(nz2,n2)); abs(umaster(nz2,n3)); abs(umaster(nz2,n4)); abs(umaster(nz2,n5))]+noise*randn(5,1);
    b3_n=[abs(umaster(nz3,n1)); abs(umaster(nz3,n2)); abs(umaster(nz3,n3)); abs(umaster(nz3,n4)); abs(umaster(nz3,n5))]+noise*randn(5,1);
...
save sens5_400 nn2 nn4 k2 k4 j2 j4 

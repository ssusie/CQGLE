...
%  n1=513; n2=518; n3=526; n4=530; n5=531;  %4 sensors 0 5 13 17
%  n1=513; n2=518; n3=523; n4=527; n5=531;  % 5 sensors 0 5 10 15 18
...
for j=1:nloop
    ...
    b1_n=[abs(umaster(nz1,n1)); abs(umaster(nz1,n2)); abs(umaster(nz1,n3)); abs(umaster(nz1,n4)); abs(umaster(nz1,n5)); abs(umaster(nz1,n6))]+noise*randn(6,1);
    b2_n=[abs(umaster(nz2,n1)); abs(umaster(nz2,n2)); abs(umaster(nz2,n3)); abs(umaster(nz2,n4)); abs(umaster(nz2,n5)); abs(umaster(nz2,n6))]+noise*randn(6,1);
    b3_n=[abs(umaster(nz3,n1)); abs(umaster(nz3,n2)); abs(umaster(nz3,n3)); abs(umaster(nz3,n4)); abs(umaster(nz3,n5)); abs(umaster(nz3,n6))]+noise*randn(6,1);
...
save sens6_400 nn2 nn4 k2 k4 j2 j4 
